import { PrismaClient, AgentRole, AgentSpecialization } from '@prisma/client';
...
5. Maintain design consistency across the application`,
  ...
  },
  {
    ...
    description: 'React specialist focused on modern frontend architecture and performance',
...
5. Follow modern React best practices`,
  ...
  },
  {
    ...
    description: 'Versatile engineer skilled in both frontend and backend development',
...
5. Ensure security best practices`,
  ...
  },
  {
    ...
    description: 'Quality assurance specialist ensuring code reliability and bug-free releases',
...
6. Verify fixes and prevent regressions`,
  ...
  },
  {
    ...
    description: 'Infrastructure and deployment specialist with cloud expertise',
...
6. Optimize deployment processes`,
  ...
  },
  {
    ...
    description: 'Strategic thinker who transforms ideas into actionable requirements',
