...
async function seedWorkflows() {
  ...
  const webAppWorkflow = await prisma.workflow.create({
    data: {
      ...
      description: 'Standard workflow for building modern web applications with Next.js and React',
      isDefault: true,
      stages: [
        {
          id: 'requirements',
        ...
        },
        {
          ...
          description: 'Tech Lead reviews requirements and breaks down into tasks',
          agentRole: 'TECH_LEAD',
        },
        {
          id: 'development',
      ...
      transitions: [
        { from: 'requirements', to: 'design', condition: 'Requirements approved' },
        { from: 'design', to: 'tech-review', condition: 'Design approved' },
        { from: 'tech-review', to: 'development', condition: 'Tasks created' },
        { from: 'development', to: 'code-review', condition: 'Feature complete' },
        {
          from: 'code-review',
          to: 'development',
        ...
        { from: 'qa-testing', to: 'development', condition: 'Bugs found', type: 'feedback' },
  ...
  const agileWorkflow = await prisma.workflow.create({
    data: {
      ...
      transitions: [
        ...
        { from: 'sprint-planning', to: 'development', condition: 'Sprint started' },
        { from: 'development', to: 'testing', condition: 'Feature complete' },
        { from: 'testing', to: 'development', condition: 'Bugs found', type: 'feedback' },
        { from: 'testing', to: 'sprint-review', condition: 'All tests passed' },
        { from: 'sprint-review', to: 'retrospective', condition: 'Review complete' },
        { from: 'retrospective', to: 'backlog', condition: 'Next sprint', type: 'feedback' },
      ],
      specializations: [
        'Agile methodology',
        'Scrum framework',
  ...
  const apiWorkflow = await prisma.workflow.create({
    data: {
      ...
      transitions: [
        { from: 'api-design', to: 'schema-design', condition: 'Design approved' },
        { from: 'schema-design', to: 'implementation', condition: 'Schema ready' },
        { from: 'implementation', to: 'documentation', condition: 'API complete' },
        { from: 'documentation', to: 'testing', condition: 'Docs ready' },
        { from: 'testing', to: 'implementation', condition: 'Issues found', type: 'feedback' },
  ...
  const uiWorkflow = await prisma.workflow.create({
    data: {
      ...
      transitions: [
        ...
        { from: 'review', to: 'mockups', condition: 'Changes requested', type: 'feedback' },
        { from: 'review', to: 'implementation', condition: 'Design approved' },
        { from: 'implementation', to: 'usability-testing', condition: 'UI complete' },
        {
  ...
  const kanbanWorkflow = await prisma.workflow.create({
    data: {
      ...
      description: 'AI-powered kanban workflow with intelligent agents handling requirements, design, development, and QA',
      isDefault: true,
      stages: [
        {
          id: 'backlog',
          name: 'Backlog',
          description: 'Tickets are created here. PO automatically analyzes and adds business requirements',
          agentRole: 'PRODUCT_OWNER',
          automationRules: {
            onTicketCreated: {
              action: 'auto-assign-po',
              behavior: 'PO analyzes ticket, creates business requirements, adds ROI notes, creates knowledge base documentation',
            },
        ...
        },
        {
          id: 'design',
          name: 'Design',
          description: 'Designer creates beautiful, modern Figma designs for frontend features',
          agentRole: 'DESIGNER',
          automationRules: {
            onTicketEntered: {
              action: 'auto-assign-designer',
              condition: 'isFrontend === true',
              behavior: 'Designer examines requirements and creates/updates Figma designs using MCP',
            },
          },
        ...
        },
        {
          id: 'unrefined',
          name: 'Unrefined',
          description: 'Tech Lead validates requirements and breaks down story into checklist',
          agentRole: 'TECH_LEAD',
          automationRules: {
            onTicketEntered: {
              action: 'auto-assign-tech-lead',
              behavior: 'Tech Lead reviews requirements, asks clarifying questions, breaks story into checklist items',
            },
            onUserConfirmation: {
        ...
        },
        {
          ...
          automationRules: {
            ...
            description: 'Any available developer can self-assign and move to In Progress',
          },
        },
        {
          id: 'in-progress',
          name: 'In Progress',
          description: 'Developer implements feature according to acceptance criteria',
          agentRole: 'FULLSTACK_ENGINEER',
          automationRules: {
            onTicketEntered: {
              behavior: 'Developer self-assigns, implements per AC, does not add extra features',
            },
            onCompletion: {
              action: 'move-to-qa',
        ...
        },
        {
          ...
          automationRules: {
            onTicketEntered: {
              ...
              behavior: 'QA Engineer writes unit, functional, and E2E tests using Vitest, react-testing-library, and Playwright',
            },
            onTestsPass: {
              action: 'move-to-review',
              condition: 'all-tests-pass && no-bugs && no-regressions',
              behavior: 'QA Engineer moves to In Review when validation complete',
            },
            onTestsFail: {
              action: 'return-to-development',
              condition: 'bugs-found || regressions-detected',
              behavior: 'QA Engineer returns to developer with detailed bug report',
            },
          },
        },
        {
          ...
          automationRules: {
            onTicketEntered: {
              action: 'auto-assign-po',
              behavior: 'PO validates work meets business requirements and acceptance criteria',
            },
            onApproval: {
              action: 'move-to-done',
      ...
      transitions: [
        ...
        { from: 'design', to: 'unrefined', condition: 'Design approved', automatedBy: 'user' },
        {
          from: 'unrefined',
          to: 'ready',
        ...
        { from: 'in-progress', to: 'qa', condition: 'Development complete', automatedBy: 'agent' },
        {
          from: 'qa',
          to: 'in-progress',
        ...
        { from: 'qa', to: 'in-review', condition: 'All tests passed', automatedBy: 'agent' },
        {
          from: 'in-review',
          to: 'in-progress',
          condition: 'Changes requested',
        ...
        { from: 'in-review', to: 'done', condition: 'Work approved', automatedBy: 'agent' },
      ],
      specializations: [
