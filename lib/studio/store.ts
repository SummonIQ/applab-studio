  ...
  persist(
    (set, get) => ({
      ...
      insertComponent: (
        ...
        set(state => {
          ...
          if (position === 'inside') {
            ...
            // Do not auto-apply `flex: 1` for newly inserted layout containers.
            // Let users opt into fill behavior explicitly (e.g. Height: Fill) so
            // justify-content and spacing controls behave predictably by default.
      ...
      insertComponentWithData: (
        ...
        set(state => {
          ...
          if (position === 'inside') {
            ...
            // Do not auto-apply `flex: 1` when inserting AI components; keep layout predictable.
      ...
      migrateCurrentPageToPageRoot: () => {
        set(state => {
          ...
          if (rootComponent && rootComponent.type === 'Page') {
            ...
            // Previously we forced the first child to fill height via `flex: 1`.
            // This made default layouts feel "stuck" and made justify/spacing controls appear broken.
            // Users can opt into fill explicitly via Height: Fill (flex: 1).
            if (rootComponent.children.length > 0) {
              ...
              // no-op: keep existing child sizing
              void firstChildComp;
            }
      ...
      moveComponent: (
        ...
        set(state => {
          ...
          if (position === 'inside') {
            ...
            // Do not auto-apply `flex: 1` when moving components; preserve user intent.
      ...
      pasteComponent: (parentId: string | null = null) => {
        ...
        // Do not auto-apply `flex: 1` on paste; keep pasted component sizing consistent.
