...
const themes = [
  {
    ...
    name: 'Zen',
    description:
      'A purple/fuchsia/pink gradient theme with glass morphism effects. Features frosted glass cards, aurora backgrounds, and smooth animations.',
    preview: {
      primary: 'from-purple-600 via-fuchsia-600 to-pink-600',
      background: 'bg-white',
      accent: 'bg-fuchsia-50',
    },
    features: ['Glass morphism', 'Gradient text', 'Aurora BG'],
  },
];
              ...
              <div className="p-4">
                ...
                <div className="mt-4 flex gap-2">
                  <Button
                    ...
                    variant="default"
                    size="sm"
                    className="flex-1 bg-gradient-to-br from-purple-600 via-purple-700 to-blue-700 hover:from-purple-500 hover:via-purple-600 hover:to-blue-600 border-t border-t-pink-400/50 text-white"
                  >
